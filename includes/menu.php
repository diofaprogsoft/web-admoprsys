...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item">
        <a class="nav-link" href="<?php $basePath ?>beranda.php">
    ...
    <li class="nav-item">
        ...
        <div id="kimper" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php $basePath ?>kimper/kimper_monitoring_home.php">Proses</a>
                <a class="collapse-item" href="<?php $basePath ?>kimper/kimper_monitoring_expired.php">Masa Berlaku</a>
                <a class="collapse-item" href="<?php $basePath ?>kimper/kimper_monitoring_files.php">Bahan Pendukung</a>
                <div class="collapse-divider"></div>
                <h6 class="collapse-header">Berkas</h6>
                <a class="collapse-item" href="#!">Pengajuan</a>
                <a class="collapse-item" href="<?php $basePath ?>kimper/kimper_archive.php">Arsip Kimper</a>
            </div>
        </div>
    </li>
